      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12">
        ...
        <div className="lg:col-span-7">
          <TextReveal delay={0.2} yOffset={24}>
            <div className="p-5 sm:p-8 rounded-[24px] bg-white dark:bg-[#161618] border border-neutral-200/80 dark:border-neutral-800 shadow-md">
            {submitted ? (
              <div className="py-12 text-center space-y-4 animate-in fade-in duration-300">
                ...
                <button
                  ...
                  className="px-6 py-2.5 rounded-full bg-[#1D1D1F] dark:bg-white text-white dark:text-[#0A0A0C] font-semibold text-13px hover:bg-[#007AFF] dark:hover:bg-[#0A84FF] dark:hover:text-white transition-colors"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-6" noValidate>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-12px font-mono uppercase tracking-wider text-[#86868B] dark:text-[#98989D] mb-2 font-medium flex items-center justify-between">
                      <span>Your Name *</span>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 rounded-xl bg-[#F5F5F7] dark:bg-[#1E1E22] border text-[#1D1D1F] dark:text-[#F5F5F7] placeholder-[#86868B] dark:placeholder-[#6E6E73] text-14px focus:outline-none transition-colors ${
                        touched.name && errors.name
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-12px font-mono uppercase tracking-wider text-[#86868B] dark:text-[#98989D] mb-2 font-medium">
                      Company / Product
                    </label>
                    <input
                      type="text"
                      ...
                      placeholder="ZARA"
                      className="w-full px-4 py-3 rounded-xl bg-[#F5F5F7] dark:bg-[#1E1E22] border border-neutral-200 dark:border-neutral-700 text-[#1D1D1F] dark:text-[#F5F5F7] placeholder-[#86868B] dark:placeholder-[#6E6E73] text-14px focus:outline-none focus:border-[#007AFF] dark:focus:border-[#0A84FF] transition-colors"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-[#F5F5F7] dark:bg-[#1E1E22] border border-neutral-200 dark:border-neutral-700 text-[#1D1D1F] dark:text-[#F5F5F7] text-14px focus:outline-none focus:border-[#007AFF] dark:focus:border-[#0A84FF] transition-colors"
                    >
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="w-full py-4 rounded-full bg-[#1D1D1F] dark:bg-white text-white dark:text-[#0A0A0C] font-semibold text-15px hover:bg-[#007AFF] dark:hover:bg-[#0A84FF] dark:hover:text-white disabled:opacity-50 transition-all flex items-center justify-center gap-2 shadow-md cursor-pointer"
                >
                  {submitting ? (
                    <>
