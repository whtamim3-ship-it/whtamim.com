...
export const CASE_STUDIES: CaseStudy[] = [
  {
    ...
    deliverables: ['Promotional Video', 'Social Cutdowns'],
    ...
    challenge: 'Delivering snappy, conversion-focused kinetic pacing.',
    goal: 'Maximize audience engagement with bold typography and seamless transitions.',
    strategy: 'Fast visual cuts, spatial rhythm, and sleek sound-synced animations.',
    storytellingApproach: 'Modern kinetic typography and motion.',
  ...
  },
  {
    ...
    budgetTier: '',
    duration: '60 Seconds',
    heroVideoUrl: 'https://res.cloudinary.com/grjdsu5n/video/upload/v1786054247/Music_jwuuat.mp4',
    posterImage: 'https://images.unsplash.com/photo-1600132806370-bf17e65e942f?q=80&w=1200&auto=format&fit=crop',
    thumbnailGridAspect: 'col-span-12 md:col-span-5',
    logline: 'Stunning dynamic weather concepts and dark mode dashboard interfaces animated with micro-interactions.',
  ...
  },
  {
    ...
    budgetTier: '',
    duration: '3 Minutes',
    heroVideoUrl: 'https://res.cloudinary.com/grjdsu5n/video/upload/v1786053944/Time%20Ui.mp4',
    posterImage: 'https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?q=80&w=1200&auto=format&fit=crop',
    thumbnailGridAspect: 'col-span-12 md:col-span-12',
    logline: 'An elegant, fluid mobile UI concept featuring seamless gesture-based navigation and high-fidelity micro-interactions.',
    ...
    motionDesignBreakdown: [
      {
        ...
        keyPoints: ['Pacing to natural speech cadence', 'Gradual emotional crescendo'],
      }
    ],
    behindTheScenes: [],
    multiFormatCuts: [],
